...
def enter_ip():
    ...
    return render_template('enter_ip.html', vm_info=vm_info)
...
def index():
    ...
    if not vyos_ip:
        ...
        return redirect(url_for('submit_ip'))
...
def vpn():
    ...
    whole_data = retrieve_data.get_vpn(vyos_ip, key)
    data = whole_data['data']['ipsec']
    site2site = data['site-to-site']
    auth = data['authentication']
    if 'psk' in auth and 'peer' not in site2site:
        authentications = data['authentication']['psk']
        peers = None
        return render_template('vpn_page.html', vpn_data = data, authentications = authentications, peers = peers)
    
    elif 'psk' not in auth and 'peer' in site2site:
        authentications = None
        peers = site2site['peer']
        return render_template('vpn_page.html', vpn_data = data, authentications = authentications, peers = peers)
    
    elif 'psk' in auth and 'peer' in site2site:   
        authentications = data['authentication']['psk']
        peers = site2site['peer']
        return render_template('vpn_page.html', vpn_data = data, authentications = authentications, peers = peers)
    else:
        data = None
        return render_template('vpn_page.html', vpn_data = data)
...
def del_auth():
    ...
    if success:
        return jsonify({'message': 'Authentication deleted successfully. Refresh you browser', 'success': True})
    else:
        return jsonify({'message': 'Failed to delete authentication. Please check the logs for more information.', 'success': False})
...
def del_peer():
    ...
    if success:
        ...
        return jsonify({'message': 'Failed to delete VPN peer. Please check the logs for more information.', 'success': False})
...
def del_outbound():
    ...
    if success:
        return jsonify({'message': 'Firewall rule deleted successfully. Refresh you browser', 'success': True})
    else:
        return jsonify({'message': 'Failed to delete rule. Please check the logs for more information.', 'success': False})
...
def delete_int_tun():
    ...
    if success:
        ...
        return jsonify({'message': 'Failed to delete interface. Please check the logs for more information.', 'success': False})
...
def configure_authentication():
    ...
    if success:
        ...
        return jsonify({'message': 'Failed to configure authentication. Please check the logs for more information.', 'success': False})
...
def configure_peer():
    ...
    if success:
        return jsonify({'message': 'VPN peer created successfully. Refresh you browser', 'success': True})
    else:
        return jsonify({'message': 'Failed to configure peer. Please check the logs for more information.', 'success': False})
...
def delete_ip():
    ...
    if success:
        return jsonify({'message': 'IP address deleted successfully. Refresh your browser.', 'success': True})
    else:
